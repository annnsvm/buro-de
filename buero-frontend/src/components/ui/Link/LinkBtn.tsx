...
const VARIANTS = {
  ...
  transparent: 'inline-flex items-center justify-center gap-2 text-[var(--color-accent-primary)] hover:text-[var(--color-accent-primary-hover)] transition-colors duration-250',
} as const;
